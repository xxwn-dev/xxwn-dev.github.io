...
Python 입문 겸 FastAPI를 써보고 싶었던 게 솔직한 이유지만 토이프로젝트인데 뭐 어떤가 싶다. 기술 선택의 근거가 타당하려면 프로젝트 규모와 기술의 특장점을 더 살펴봐야한다는 것을 한 번 더 깨닫고 기분 전환이 됐다는 것으로 이 토이 프로젝트의 가치는 나에게는 충분했다.
